...
resource "aws_cognito_user_pool_domain" "main" {
  domain       = "${var.name_prefix}-${var.aws_account_id}${var.dash}"
...
resource "aws_cognito_user_pool_client" "alb" {
  ...
  callback_urls = ["https://placeholder.${var.subdomain}/oauth2/idpresponse"]
  logout_urls   = ["https://placeholder.${var.subdomain}/logout"]
